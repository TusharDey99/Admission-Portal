...
public class BFSSylhet implements Methods {
    ...
    int dorm = roomChoice.dormChoice;
    ...
    public void informationInput()
    {
        ...
        showInfo.writeStudentInfo(name, dateOfBirth, schoolName, collegeName, division, sscYear, hscYear, sscGPA, hscGPA,
                dt, tm);
    }
    ...
    public void infoPrinting()
    {
        ...
        if (dorm == 1) {
            System.out.print("Your student dorm: ");
            if (v == 4)
                System.out.println("Moulvibazar Student Dorm Service, Moulvibazar.");
            else if (v == 5)
                System.out.println("Sylhet Student Dorm Service, Sylhet.");
        }
        System.out.println("Your dorm room number: "+(int)(Math.random()*49));
        System.out.println("Your dorm room pass: Same as exam authentication pass.");
