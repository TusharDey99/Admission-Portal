...
public class BFSChottogram extends BFSSylhet{
    ...
    public void infoPrinting() {
        ...
        if (dorm == 1) {
            ...
            if (v == 4)
                System.out.println("Nanupur Student Dorm Service, Nanupur.");
            else if (v == 5)
                System.out.println("Gopal Ghata Student Dorm Service, Gopal Ghata.");
        }
        System.out.print("Your dorm room number: "+(int)(Math.random()*49));
